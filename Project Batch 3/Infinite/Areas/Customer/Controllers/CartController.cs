...
using batch3.Utils;
using batch3.ViewModels;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Stripe.Checkout;
using static System.Net.WebRequestMethods;

namespace batch3.Areas.Customer.Controllers
{
    [Area("Customer")]
    [Authorize]
            ...
            if (user.CompanyId.GetValueOrDefault() == 0)
            {
                ...
                foreach (var cart in ShoppingCartVM.List)
                {
                    var SessionLineItem = new Stripe.Checkout.SessionLineItemOptions
                    {
                        ...
                        {
                            UnitAmount = (long)(cart.Price * 100), // Convert price to paise without rounding
                            Currency = "inr", // Set currency to INR (lowercase)
